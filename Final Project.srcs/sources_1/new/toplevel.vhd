...
signal master_data_parallel_sig, slave_data_parallel_sig, o_x_axis_data_sig, o_y_axis_data_sig, o_z_axis_data_sig : std_logic_vector(N-1 downto 0);
...
fsm : entity work.fsm(simple)
	port map(
        ...
        o_xaxis_data    => o_x_axis_data_sig,
